...
object PodcastHandler {
    private const val TAG: String = "PodcastHandler"
...
//                        Logd(TAG, "startPrefixMapping can not handle prefix: $prefix uri: $uri")
        ...
        companion object {
            private const val TAG: String = "SyndHandler"
                        ...
                        parent.name.matches(isFeedItem.toRegex()) -> {
                            when (rel) {
                                ...
                                LINK_REL_ENCLOSURE -> {
                                    ...
                                    var size: Long = 0
                                    try { if (strSize != null) size = strSize.toLong() } catch (e: NumberFormatException) {
...
//                        Logd(TAG, "Atom handleElementEnd duration: $duration")
        ...
        companion object {
            private const val TAG: String = "Atom"
...
//            Logd(TAG, "Media handleElementEnd $localName")
        ...
        companion object {
            private const val TAG: String = "Media"
...
//                            Logd(TAG, "Rss20 handleElementEnd duration: $duration")
        ...
        companion object {
            private const val TAG: String = "Rss20"
    ...
    class SimpleChapters : Namespace() {
        ...
        companion object {
            private const val TAG: String = "SimpleChapters"
